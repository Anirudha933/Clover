...
module.exports = {
  ...
  nodemailerTransport: {
    service: 'gmail', // example: hotmail (leave blank if using own smtp below)
    host: process.env.HOST_EMAIL, // example: smtp.yourdomain.tld (leave blank if using service above)
    port: 587, // example: 587 (leave blank if using service above)
    secure: true, // require STARTTLS, can be true or false (leave blank if using service above)
    auth: {
